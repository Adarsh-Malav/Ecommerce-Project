                 ...
                 %>
                   <form class="comments-form contact-form" action="ProductController" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">                        
                          <input type="text" placeholder="Your Product Name" class="form-control" name="product_name">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">                        
                          <input type="text" placeholder="Your Product Price" class="form-control" name="product_price">
                        </div>
                      </div>
                   ...
                   <div class="row">
                     <div class="col-md-6">
                    	<div class="form-group">                        
                      	<textarea class="form-control" rows="3" placeholder="Product Description" name="product_desc"></textarea>
                    	</div>
                 	 </div>
                   </div>
                    ...
                    <button class="aa-secondary-btn" name="action" value="add product">Add Product</button>
                  </form>
               </div>
               </div>
