                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="men">
                      <ul class="aa-product-catg">
                        ...
                        <li>
                          <figure>
                            <a class="aa-product-img" href="#"><img src="product_images/<%=p.getProduct_image()%>" style="height: 300px; width: 250px"></a>
                            <a class="aa-add-card-btn"href="seller-product-details.jsp?pid=<%=p.getPid()%>">Product Details</a>
                              <figcaption>
