           ...
           <div class="aa-contact-address">
             <div class="row">
               <div class="col-md-12">
                 ...
                 %>
                   <form class="comments-form contact-form" action="UserController" method="post">
                     <div class="row">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">                        
                          <input type="text" placeholder="Your First Name" class="form-control" name="fname">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">                        
                          <input type="text" placeholder="Your Last Name" class="form-control" name="lname">
                        </div>
                      </div>
