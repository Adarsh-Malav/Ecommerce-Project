            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-right">
                ...
                <%
                 ...
                 %>
                 		<li class="hidden-xs"><a href="seller-change-password.jsp">Change Password</a></li>
                 		<li class="hidden-xs"><a href="logout.jsp">Logout(<%=u.getFname()%>)</a></li>
                 <%
                  		}
                  		else
                  		{
